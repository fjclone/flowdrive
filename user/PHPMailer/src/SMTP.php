...
class SMTP
{
     ...
     * Starts a mail transaction from the email email specified in
     * $from. Returns true if successful or false otherwise. If True
     * the mail transaction is started and then one or more recipient
     * commands may be called followed by a data command.
     * Implements RFC 821: MAIL <SP> FROM:<reverse-path> <CRLF>.
     *
     * @param string $from Source email of this message
     *
     * @return bool
     */
     ...
     *
     * @param string $email The email the message is being sent to
     * @param string $dsn     Comma separated list of DSN notifications. NEVER, SUCCESS, FAILURE
     *                        or DELAY. If you specify NEVER all other notifications are ignored.
     *
     * @return bool
     */
    public function recipient($email, $dsn = '')
    {
        if (empty($dsn)) {
            $rcpt = 'RCPT TO:<' . $email . '>';
        } else {
            ...
            $rcpt = 'RCPT TO:<' . $email . '> NOTIFY=' . implode(',', $notify);
        }
     ...
     * Starts a mail transaction from the email email specified in $from.
     ...
     *
     * @param string $from The email the message is from
     *
     * @return bool
     */
    ...
    /**
     * Enable or disable VERP email generation.
     *
     * @param bool $enabled
     */
    ...
    /**
     * Get VERP email generation mode.
     *
     * @return bool
     */
