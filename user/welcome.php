...
if (isset($_POST['submit'])) {
    ...
    $password = $_POST['password']; // Store plaintext password for hashing
            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        // Recipients
                        $mail->setFrom('francinejane.sd@gmail.com', 'Your Name'); // Your email address
                        $mail->addAddress($email); // Add the recipient's email address

                        // Content
                        $mail->isHTML(true); // Set email format to HTML
                        $mail->Subject = 'Verification Email';
                        $mail->Body    = 'Here is the verification link: <b><a href="http://localhost/login/?verification='.$code.'">Verify Your Email</a></b>';
