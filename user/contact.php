          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Address</h3>
                <p>Cardona Rizal<br>Morong, Rizal</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Call Us</h3>
                <p>+ 63 912 9977 293<br>+63 966 0063 732</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                <i class="bi bi-envelope"></i>
                <h3>Email Us</h3>
                <p>dioncandelaria@gmail.com<br>francinejane.sd@gmail.com</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
          ...
          <div class="card p-4">
            <form action="forms/contact.php" method="post" class="php-email-form">
              <div class="row gy-4">
                ...
                <div class="col-md-12">
                  <textarea class="form-control" name="message" rows="6" placeholder="Message" required style="resize: none;"></textarea>
                </div>
