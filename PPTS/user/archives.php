...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">User Logs</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="ad-row">
        <div class="ad-proj-con">
          <div class="ad-proj-in">
              <div class="ad-proj-code">Project:</div>
              <div class="ad-proj-code-log">CS-51</div>
          </div>
      
          <div class="ad-proj-in">
              <div class="ad-user">User:</div>
              <div class="ad-user-log">Ramcel Gamboa</div>
          </div>
      
          <div class="ad-proj-in">
              <div class="ad-proj-task">Task:</div>
              <div class="ad-proj-task-log">Chapter 1</div>
          </div>
      
          <div class="ad-proj-in">
              <div class="ad-proj-act">Activity Log:</div>
              <div class="ad-proj-act-log">Commented</div>
          </div>
      
          <div class="ad-proj-in">
              <div class="ad-time-stamp">Time Stamp:</div>
              <div class="ad-time-stamp-log">October 03, 2024 | 9:15 PM</div>
          </div>
      </div>
    </div>
    <div class="row">
